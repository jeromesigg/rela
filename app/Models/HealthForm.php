...
class HealthForm extends Model implements Auditable
{
    ...
    protected $fillable = [
        ...
        'doctor_contact', 'health_insurance_contact', 'accident_insurance_contact', 'liability_insurance_contact', 'finish', 'birthday', 'phone_number', 'swimmer', 'vaccination', 'file_allergies'
    ];
