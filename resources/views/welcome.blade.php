        ...
        <section class="py-5 bg-gray-400 text-dark__white">
            <div class="container">
                <div class="row gy-4 align-items-center">
                    ...
                    <div class="col-md-6"><img class="img-fluid d-block mx-auto" src="img/template-dashboard.png"
                                               alt="..."></div>
                </div>
            </div>
        </section>
            ...
            <section class="py-5 bg-gray-400 text-dark__white">
                <div class="container">
                    <div class="row gy-4 align-items-center">
                        ...
                        <div class="col-md-6"><img class="img-fluid d-block mx-auto" src="img/template-intervention.png" alt="...">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="bg-primary py-5 text-dark__white">
                <div class="container text-center">
                    <div class="row">
                        ...
                        <div class="col-lg-2 p-3"><a class="btn btn-outline-light" href="/home">Teilnehmende</a><br>Code 100001 und Camp 1234</div>
                    </div>
                </div>
            </div>
        </div>
