    ...
    <div class="wide" id="all">
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dashboard/healthstatus">Überwachung der Vitalfunktionen</a></li>
                    <li class="breadcrumb-item active">Erfassen</li>
                </ul>
            </div>
        </div>
        <br>
        {!! Form::model($healthstatus, ['method' => 'POST', 'action'=>'HealthStatusController@store']) !!}
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                {!! Form::label('gcs', 'GCS:') !!}
                {!! Form::text('gcs', null, ['class' => 'form-control', 'required']) !!}
            </div>
            <div class="form-group col-md-4">
                {!! Form::label('vital_function', 'Vital-Funktion:') !!}
                {!! Form::text('vital_function', null, ['class' => 'form-control', 'required']) !!}
            </div>
        </div>
        <div class="form-row">
